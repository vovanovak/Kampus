...
(
    [UserRecoveryId] INT PRIMARY KEY IDENTITY (1, 1),
...
(
    [WallPostLikeId] INT PRIMARY KEY IDENTITY (1, 1),
...
(
    [WallPostFileId] INT PRIMARY KEY IDENTITY (1, 1),
    [WallPostId]     INT NOT NULL FOREIGN KEY REFERENCES [dbo].[WallPosts] ([WallPostId]),
...
(
    [MessageFileId] INT PRIMARY KEY IDENTITY (1, 1),
...
(
    [TaskLikeId] INT PRIMARY KEY IDENTITY (1, 1),
    [LikerId]    INT NOT NULL FOREIGN KEY REFERENCES [dbo].[Users] ([UserId]),
    [TaskId]     INT NOT NULL FOREIGN KEY REFERENCES [dbo].[Tasks] ([TaskId])
)
GO
...
(
    [TaskFileId] INT PRIMARY KEY IDENTITY (1, 1),
    [TaskId]     INT NOT NULL FOREIGN KEY REFERENCES [dbo].[Tasks] ([TaskId]),
    [FileId]     INT NOT NULL FOREIGN KEY REFERENCES [dbo].[Files] ([FileId]),
)
GO
